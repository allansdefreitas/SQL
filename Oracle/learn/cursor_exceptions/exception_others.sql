...
EXECUTE incluir_cliente(18, 'LOJA FREITAS NOME MUITO GRANDE ENORMEMENTE GRANDE PARA UMA RAZAO SOCIAL, DE MODO QUE EXTRAPOLA O LIMITE DE 100 CARACTERES ESPECIFICADO NA FORMA DE VARCHAR(100)', '54234897897', 1, 250000);
...
EXCEPTION
    ...
    WHEN others THEN -- others deve ser sempre o último handler
        RAISE_APPLICATION_ERROR(-20000, 'ERRO NÃO ESPERADO!');
END;
